"""
Django settings for isp_erp_backend project.
...
SECRET_KEY = 'django-insecure-cc&68n3#0zzaube_#php@@l(@l76b3s%61+6j)78i0*gq1wi4&'
...
ROOT_URLCONF = 'isp_erp_backend.urls'
...
WSGI_APPLICATION = 'isp_erp_backend.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'cobranza': {'handlers': ['console'], 'level': 'INFO', 'propagate': False},
    },
}
